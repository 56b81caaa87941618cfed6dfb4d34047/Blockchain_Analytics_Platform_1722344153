...
Vue.component("simple_header_component_1722344156", {
    ...
    <div class="flex">
        <aside class="w-64 h-screen bg-gray-800 text-white">
            <nav class="p-4">
                <ul>
                    <li class="mb-4"><a href="#" class="block py-2 px-4 hover:bg-gray-700 rounded">Home</a></li>
                    <li class="mb-4"><a href="#" class="block py-2 px-4 hover:bg-gray-700 rounded">About</a></li>
                    <li class="mb-4"><a href="#" class="block py-2 px-4 hover:bg-gray-700 rounded">Contact</a></li>
                </ul>
            </nav>
        </aside>
        <div class="flex-1">
