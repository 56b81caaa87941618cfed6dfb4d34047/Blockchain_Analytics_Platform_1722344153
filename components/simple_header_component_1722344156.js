...
Vue.component("simple_header_component_1722344156", {
    template: `
    <div class="flex">
        <aside class="w-64 h-screen bg-white text-black shadow-lg">
            <nav class="p-4">
                <ul>
                    <li class="mb-4"><a href="#" class="block py-2 px-4 hover:bg-purple-100 rounded">Home</a></li>
                    <li class="mb-4"><a href="#" class="block py-2 px-4 hover:bg-purple-100 rounded">About</a></li>
                    <li class="mb-4"><a href="#" class="block py-2 px-4 hover:bg-purple-100 rounded">Contact</a></li>
                </ul>
            </nav>
        </aside>
        <div class="flex-1">
            <header id="header-section" class="w-full">
                <nav id="nav-bar" class="bg-white border-gray-200 py-2.5">
                    <div id="nav-container" class="flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto">
                        <a id="logo-link" href="#" class="flex items-center">
                            ...
                            <span id="app-name" class="self-center text-xl font-semibold whitespace-nowrap text-black">Blockchain Analytics Suite</span>
                        </a>
                        <div id="menu-toggle-button" class="flex items-center lg:order-2">
                            <button id="collapse-button" data-collapse-toggle="mobile-menu-2" type="button" class="inline-flex items-center p-2 ml-1 text-sm text-gray-500 rounded-lg lg:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200" aria-controls="mobile-menu-2" aria-expanded="false">
                        ...
                        <div id="mobile-menu-2" class="items-center justify-between hidden w-full lg:flex lg:w-auto lg:order-1">
                            <ul id="nav-list" class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                                <li id="nav-item-home"><a href="#" class="block py-2 pl-3 pr-4 text-white bg-purple-700 rounded lg:bg-transparent lg:text-purple-700 lg:p-0" aria-current="page">Real-time Blockchain Monitoring</a></li>
